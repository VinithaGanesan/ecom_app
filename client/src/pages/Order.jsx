  ...
  return (
    <div className='container mx-auto py-8 px-4 md:px-16 lg:px-24'>
        ...
        <div className='mt-6 p-4 border rounded-lg bg-gray-100'>
            ...
            <div className='mt-6'>
                <button className='bg-green-500 tex-white py-2 px-4 hover:bg-green-600 rounded'>Track Order</button>
                <button 
                className='ml-4 bg-black text-white py-2 px-4 hover:bg-gray-600 rounded'
                    onClick={() => navigate('/')}
                >
                    Continue Shopping
                </button>
